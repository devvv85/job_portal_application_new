...
class experiencesocialogin extends StatefulWidget
{
  @override
  State<StatefulWidget> createState() => new _State();

  experiencesocialogin(String struserType, String selectedSkill, String selectedLoc) {
...
class _State extends State<experiencesocialogin> {
